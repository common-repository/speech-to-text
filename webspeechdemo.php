...
$browser="";
     if(strpos(strtolower($_SERVER["HTTP_USER_AGENT"]),strtolower("MSIE"))){?>
         <p id="info_upgrade"  style="text-align:center;">Web Speech API is not supported by this browser.
...
<div class="right">
  <button id="start_button" onclick="startButton(event)">
    <!--<img id="start_img" src="<?php echo plugin_dir_path( __FILE__ ) ?>\images\mic.gif" alt="Start"></button>-->
...
jQuery(document).ready(function(){
    jQuery("#start_button, #copy_button").click(function(e){
    e.preventDefault()
});
});
showInfo('info_start');
